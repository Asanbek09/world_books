...
class Author(models.Model):
    ...
    last_name = models.CharField(max_length=100, help_text="Введите фмилию автора", verbose_name="Фамилия автора")
...
class BookInstance(models.Model):
    ...
    inv_nom = models.CharField(max_length=20, null=True, help_text="", verbose_name="")
    status = models.ForeignKey('Status', on_delete=models.CASCADE, null=True, help_text="", verbose_name="")
    due_back = models.DateField(null=True, blank=True, help_text="", verbose_name="")
