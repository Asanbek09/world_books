# Generated by Django 4.2.10 on 2024-03-05 04:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(help_text='Введите фмилию автора', max_length=100, verbose_name='Фамилия автора')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inv_nom', models.CharField(max_length=20, null=True, verbose_name='')),
                ('due_back', models.DateField(blank=True, null=True, verbose_name='')),
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.book')),
                ('status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='')),
            ],
            options={
                'ordering': ['due_back'],
            },
